...
INSERT INTO `admin` VALUES ('wilfried.rolland.dev@gmail.com','0B86doJPy1gP0h$2Q#QF@swF');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`niwee`@`%`*/ /*!50003 TRIGGER init_dates 
BEFORE INSERT 
ON `user`
FOR EACH ROW 
BEGIN
...
-- Dump completed on 2020-09-25 14:02:48
